                        ...
                        <div class="table-responsive">
                            <table class="table text-start align-middle table-bordered table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${listFeedbackProduct}" var="item"><tr>
                                            <td>${item.feedbackProductID}</td>
                                            <td><a href="${pageContext.request.contextPath}/feedback_product/view_reply/${item.feedbackProductID}.htm">${item.content}</a></td>
                                            <td>${item.createdAt}</td>
                                            <td>${item.numberStars}</td>
                                            <td>${item.phone}</td>
                                            <td>${item.productID}</td>
                                            <td>
                                                <%--<c:if test="${item.feedbackProductID == null}">--%>
                                                    <a class="btn btn-sm btn-primary" href="${pageContext.request.contextPath}/feedback_product/reply/${item.feedbackProductID}.htm">Reply</a>
                                                <%--</c:if>--%>
                                            </td>
                                            <td>
                                                <a class="btn btn-sm btn-primary" href="${pageContext.request.contextPath}/feedback_product/delete/${item.feedbackProductID}.htm">Delete</a>
                                            </td>
                                        </tr>
                                    </c:forEach>

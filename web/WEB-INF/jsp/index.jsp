            ...
            <main>
                <div id="carousel-home">
                    <div class="owl-carousel owl-theme">
                        <div class="owl-slide cover" style="background-image: url(${pageContext.request.contextPath}/img/news/1.jpg);">
                        ...
                        <!--/owl-slide-->
                        <div class="owl-slide cover" style="background-image: url(${pageContext.request.contextPath}/img/news/2.jpg);">
                            <div class="opacity-mask d-flex align-items-center" data-opacity-mask="rgba(0, 0, 0, 0.5)">
                                <div class="container">
                        ...
                        <!--/owl-slide-->
                        <div class="owl-slide cover" style="background-image: url(${pageContext.request.contextPath}/img/news/3.jpg);">

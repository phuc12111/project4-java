        ...
        <div class="container-fluid position-relative d-flex p-0">
            ...
            <div class="content">
                ...
                <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                    ...
                    <form action="${pageContext.request.contextPath}/pay/search.htm" method="get" class="d-none d-md-flex ms-4">
                        <input class="form-control bg-dark border-0" type="search" placeholder="Search payment name" name="paymentName">
                    ...
                    <div class="navbar-nav align-items-center ms-auto" style="padding: 15px 0">
                        <div class="nav-item dropdown">
                            <a class="btn btn-sm btn-primary" href="${pageContext.request.contextPath}/pay/add.htm">Add Admin</a>
                        </div>
                    </div>
                </nav>
                <!-- Navbar End -->
                        ...
                        <div class="table-responsive">
                            <table class="table text-start align-middle table-bordered table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${payments}" var="pay"><tr>
                                            <td>${pay.paymentID}</td>

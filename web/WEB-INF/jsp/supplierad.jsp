        ...
        <div class="container-fluid position-relative d-flex p-0">
            ...
            <div class="content">
                ...
                <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                    ...
                    <form action="${pageContext.request.contextPath}/supplier/find.htm" method="get" class="d-none d-md-flex ms-4">
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="bg-secondary text-center rounded p-4">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <h6 class="mb-0">Manage Supplier</h6>
                            <a href="">Show All</a>
                            <h1>${message}</h1>
                            <h1>${error}</h1>
                        </div>
                        <div class="table-responsive">
                            <table class="table text-start align-middle table-bordered table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${listSupplier}" var="sup"><tr>
                                            <td>${sup.supplierID}</td>
                                            <td>${sup.supplierName}</td>
                                            <td>${sup.email}</td>
                                            <td>${sup.phone}</td>
                                            <td>${sup.description}</td>
                                            <td><img class="rounded-circle" src="${pageContext.request.contextPath}/${sup.picture}" alt="" style="width: 40px; height: 40px;"></td>
                                            <td>
